...
If you'd rather use the models on your own metal, or if you want to fine-tune them on your specific tasks without training data, use our open-source [Artifex library](https://github.com/tanaos/artifex). Additionally, all models are available for downloaded from our [Hugging Face page](https://huggingface.co/tanaos).
